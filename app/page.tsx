...
export default function Home(){
 ...
 <footer className="studio-footer"><span>{state.explode>.8?t('dragPan',lang):t('dragOrbit',lang)} <b>·</b> {t('pinchZoom',lang)} <b>·</b> {t('tapInspect',lang)}</span><a className="brand-footer" href="https://aievolutionpolska.pl" target="_blank" rel="noreferrer" title="aievolutionpolska.pl"><img src="/brand/logo-mark.png" alt=""/><span className="brand-footer-name">AI EVOLUTION POLSKA</span><span className="brand-footer-url">aievolutionpolska.pl</span></a><Button variant="ghost" onClick={()=>{setDetails(false);setPanel(null);setAbout(true);}}>{t('sourceCredits',lang)} <ArrowUpRight size={12}/></Button></footer>
 ...
 <Sheet open={about} onOpenChange={setAbout}><SheetContent className="about-sheet glass"><div className="eyebrow">{t('aboutEyebrow',lang)}</div><SheetTitle className="structure-title">{t('aboutTitle',lang)}</SheetTitle><SheetDescription>{t('aboutDesc',lang)}</SheetDescription><div className="about-copy"><p><strong>{aboutP1[0]}</strong><br/>{aboutP1[1]}</p><p>{t('aboutP2',lang)}</p><p>{t('aboutP3',lang)}</p><h3>{t('sourceHeading',lang)}</h3><p>{t('sourceBody',lang)}</p><a href="https://dbarchive.biosciencedbc.jp/en/bodyparts3d/lic.html" target="_blank" rel="noreferrer">{t('datasetLicense',lang)} <ArrowUpRight size={14}/></a><a href="https://dbarchive.biosciencedbc.jp/en/bodyparts3d/download.html" target="_blank" rel="noreferrer">{t('originalData',lang)} <ArrowUpRight size={14}/></a><a href="https://academic.oup.com/nar/article/37/suppl_1/D782/1000752" target="_blank" rel="noreferrer">{t('sourcePublication',lang)} <ArrowUpRight size={14}/></a><div className="about-brand"><img src="/brand/logo-aiep.png" alt="AI Evolution Polska"/><span>{t('madeBy',lang)} AI Evolution Polska · aievolutionpolska.pl</span></div></div></SheetContent></Sheet>
 </main>;
}
